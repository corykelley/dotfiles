...
ZSH_THEME="robbyrussell"a# If you come from bash you might have to change your $PATH.
# export PATH=$HOME/bin:$HOME/.local/bin:/usr/local/bin:$PATH
...
alias localdelete="git branch -d"
alias remotedelete="git push origin --delete"
